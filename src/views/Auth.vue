<template>
  <div
    ...
    tabindex="-1"
    style="top: 0px; position: absolute; height: 793px"
  >
...
<style>
.my-bg {
  background: url("https://cdn.vietnammoi.vn/stores/news_dataimages/vantt/112017/02/09/5124_pasted_image_0_14.jpg")
    no-repeat;
