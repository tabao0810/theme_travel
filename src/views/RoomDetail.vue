<template>
  <div class="listing-slider mfp-gallery-container margin-bottom-0">
    <a href="" class="item mfp-gallery" title="Title 1">
      <img
        src="../../public/images/single-listing-01.jpg"
        alt=""
        style="width: 100%; height: 100%"
        loading="lazy"
      />
    </a>
    <a href="" class="item mfp-gallery" title="Title 3">
      <img
        src="../../public/images/single-listing-02.jpg"
        alt=""
        style="width: 100%; height: 100%"
        loading="lazy"
      />
    </a>
    <a href="" class="item mfp-gallery" title="Title 2">
      <img
        src="../../public/images/single-listing-03.jpg"
        alt=""
        style="width: 100%; height: 100%"
        loading="lazy"
      />
    </a>
    <a href="" class="item mfp-gallery" title="Title 4">
      <img
        src="../../public/images/single-listing-04.jpg"
        alt=""
        style="width: 100%; height: 100%"
        loading="lazy"
    /></a>
